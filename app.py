...
def check_availability():
    ...
    try:
        ...
        print(f"ERREUR CRITIQUE checkAvailability: {str(e)}")
        traceback.print_exc()
...
def book_restaurant():
    ...
    try:
        ...
        print(f"DEBUG - bookRestaurant: name={customer_name}, datetime={start_datetime}, guests={guests}")
        ...
        print(f"ERREUR CRITIQUE bookRestaurant: {str(e)}")
        traceback.print_exc()
        return jsonify({"status": "error", "message": str(e)}), 500
